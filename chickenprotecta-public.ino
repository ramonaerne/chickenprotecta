...
void setup()
{
  ...
  //s_door.writeMicroseconds(readEEPROM(D_OPEN_A));
  //s_slider.write(90);
  //s_door.writeMicroseconds(readEEPROM(D_CLOSE_A));
  //s_slider.write(readEEPROM(S_CLOSE_A));
